...
class Point(object):
    ...
    def __init__(self, x, y):
        """Construct a new Point located at the given x, y."""
        self.x = x
        self.origX = x
        self.y = y
        self.origY = y
    ...
    def clone(self):
        """ Creates and return a new point at the same x y as self.x, self.y"""
    ...
    def get_distance_from_start(self):
        distance = math.sqrt((self.x - self.origX)**2 + (self.y - self.origY)**2)
        return distance
    ...
    def halfway_to(self, p2):
        half = Point((self.x + p2.x)/2, (self.y + p2.y)/2)
        return half
########################################################################
